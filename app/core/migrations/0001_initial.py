    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('kind', models.CharField(choices=[('ADMIN', 'Admin'), ('CUSTOMER', 'Customer'), ('CUSTOMER_SERVICE', 'Customer_Service'), ('MANAGER', 'Manager'), ('LOCATION_MANAGER', 'Location_Manager'), ('OTHER', 'Other'), ('SUPER_ADMIN', 'Super Admin'), ('UNDEFINED', 'Undefined')], default='UNDEFINED', max_length=20)),
